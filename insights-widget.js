...
const INSIGHTS_DATA = [
  // ===== 2026-05-14 每日扫描 =====
  {
    ...
    body: "阶跃星辰确认完成约 25 亿美元新一轮融资，腾讯老股东跟投，公司已拆除红筹架构加速赴港 IPO，计划 6 月 30 日前交表，预期基础估值约 100 亿美元。本轮新进投资方里最值得关注的不是腾讯，而是华勤技术（手机 ODM 巨头）、龙旗科技、豪威集团（CMOS 传感器）、中兴通讯——四家均为智能手机产业链核心玩家。供应链大厂以股权形式押注大模型，不是为了财务回报，而是在赌一个位置：当 AI 大模型在 3 年内进入 AI 手机、AI 眼镜、边缘设备，谁是优先硬件制造合作伙伴？这条逻辑和高通投资 ARM 的底层算盘一致——锁定下一代软硬件接口。负面数据同时需要记录：阶跃 5 个月烧掉约 171 亿元，腾讯云战略合作（AI 汽车座舱整合腾讯地图/支付/音乐生态）是当前最重要的变现抓手，IPO 冲刺背后商业化压力极大。对硬件创业者的实操含义：如果你的产品需要嵌入大模型能力（AI 眼镜、消费机器人、智能家居中控），ODM/传感器厂是被低估的战略股东候选——他们不只带资金，还带制造产能与渠道关系",
    persons: [],
    sources: [
      { label: "财新 阶跃星辰融资 25 亿美元 2026-05-08", url: "https://m.caixin.com/m/2026-05-08/102442074.html" },
      { label: "新浪财经 腾讯跟投阶跃星辰 2026-05-11", url: "https://finance.sina.com.cn/stock/t/2026-05-11/doc-inhxphzf1893542.html" },
      { label: "新浪财经 融资 25 亿产业链巨头站队 2026-05-13", url: "https://finance.sina.com.cn/stock/aigcy/2026-05-13/doc-inhxteiv4708927.shtml" }
    ]
  },
