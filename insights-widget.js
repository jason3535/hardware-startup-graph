...
const INSIGHTS_DATA = [
  ...
  // ===== WEEKLY TRENDS 2026-05-03 (新增) =====
  {
    id: "trend-2026-05-03-manus-block",
    date: "2026-05-03",
    type: "trend",
    graphs: ["hardware"],
    pinned: false,
    title: "中国叫停 Meta 20 亿美元收购 Manus：AI 技术主权的警示枪",
    body: "4 月 27 日，国家发改委要求 Meta 和 Manus 解除已完成的 20 亿美元收购协议。Manus 由华人工程师团队于 2022 年创立，2025 年中将总部迁往新加坡，Meta 于 2025 年 12 月宣布完成收购。北京的介入时间点极为罕见——协议已签、员工已入职 Meta、LP 已套现，但中国仍强制回滚。这是中国首次对「已完成的境外 AI 收购」行使否决权，信号意义远超实际损失：AI 人才和技术能力被定义为核心国家安全资产，任何'搬迁+出售'的套现路径都可能被溯及阻断。\n\n对硬件和具身赛道的直接含义：一旦这条逻辑扩大适用，深度参与中国军民两用技术的创始团队出境套现难度会显著提高，跨境 LP（尤其中东 / 美国养老金）的「中国项目退出预期」将重新定价。短期看利空跨境融资，中期看会把最优秀的中国 AI/硬件团队锁在国内资本市场，对 A 股和港股是纯利好。",
    persons: [],
    sources: [
      { label: "CNBC 2026-04-27", url: "https://www.cnbc.com/2026/04/27/meta-manus-china-blocks-acquisition-ai-startup.html" },
      { label: "TechCrunch 2026-04-27", url: "https://techcrunch.com/2026/04/27/china-vetoes-metas-2b-manus-deal-after-months-long-probe/" }
    ]
  },
  {
    id: "trend-2026-05-03-grid-procurement",
    date: "2026-05-03",
    type: "trend",
    graphs: ["hardware"],
    pinned: false,
    title: "国家电网 68 亿采购 8500 台机器人：B2G 成具身智能最确定性需求",
    body: "4 月 24-27 日，国家电网内部《2026 年具身智能发展规划》全面披露：全年集中采购约 8500 台具身智能设备，总投资 68 亿元。拆分：5000 台四足巡检机器狗（预算 15 亿）、500 台人形带电作业机器人（预算 25 亿）、3000 台双臂巡检机器人（预算 18 亿），其余 12 亿用于研发和人才。所有采购设备需符合《电力具身智能设备技术规范》，优先支持「光明电力大模型」本地化部署。已确认供应商含宇树、智元、优必选、傅利叶等。\n\n这是具身智能有史以来最大单笔 B2G 采购，且性质是集中框架协议而非分散试验——直接打开了「有收入 + 有利润率」这个具身赛道 2026 年关键叙事。如果南方电网和地方能源集团跟进，2026 年电力行业总投资有望破百亿。硬件创业者的启示：国家电网这种「强周期 + 严格技术规范 + 长期采购框架」客户，对供应商来说是「慢热但极稳定」的收入来源，而不是一次性订单。",
    persons: [
      { id: "wangxingxing", name: "王兴兴（宇树）" },
      { id: "pengzhihui", name: "彭志辉（智元）" },
      { id: "zhoujianping", name: "周剑（优必选）" }
    ],
    sources: [
      { label: "新浪财经 2026-04-25", url: "https://finance.sina.com.cn/wm/2026-04-25/doc-inhvtwhv0456462.shtml" },
      { label: "OFweek 机器人 2026-04", url: "https://robot.ofweek.com/2026-04/ART-8321202-8420-30686053.html" }
    ]
  },
  {
    id: "trend-2026-05-03-raas-rental",
    date: "2026-05-03",
    type: "trend",
    graphs: ["hardware"],
    pinned: false,
    title: "机器人租赁（RaaS）成独立赛道：擎天租 4 个月 4 轮融资",
    body: "4 月 29 日，擎天租完成数亿元 Pre-A 轮（第 4 轮），正大集团、长信股份、美格智能、蓝思科技产业方参投，高瓴老股东超额认购。擎天租于 2025 年 12 月由智元机器人联创背景团队发起，CEO 李一言，COO 陈艳霞（前饿了么副总裁）。上线 3 周用户破 20 万，当前接入可调度机器人超 4000 台，覆盖全国逾百城，日租价格已从 10 万元/天降至 3000-5000 元/天（竞争催熟）。\n\n机器人租赁不是过渡形态，是硬件资产化和商业化的必经阶段：买方无需一次性采购贵重本体，卖方则借此积累真实场景数据和使用数据。RaaS 的逻辑跟充电宝租赁（怪兽）、共享单车（摩拜）本质相同——先把使用频次做起来，再反哺数据训练和本体迭代。ABI Research 预测 2026 年 RaaS 装机容量将达 130 万台、年营收接近 340 亿美元。对于尚未规模化交付的具身初创来说，与擎天租这类聚合平台合作比自己组建销售团队效率高得多。",
    persons: [],
    sources: [
      { label: "新浪科技 2026-04-29", url: "https://finance.sina.com.cn/tech/roll/2026-04-29/doc-inhwckrq6882014.shtml" },
      { label: "新浪财经 2026-04-30", url: "https://finance.sina.com.cn/stock/roll/2026-04-30/doc-inhwfayn7704414.shtml" }
    ]
  }
];
