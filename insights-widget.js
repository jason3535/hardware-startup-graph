...
const INSIGHTS_DATA = [
  {"id": "noam-brown-agent-swarms-2026-09", "date": "2026-09-17", "type": "research", "graphs": ["ai-scholar"], "pinned": false, "title": "Noam Brown 上 Dwarkesh：智能体集群与递归自我改进，OpenAI 的推理线下一步不是更大的单模型", "body": "**9 月 17 日，OpenAI 推理研究负责人 Noam Brown 做客 Dwarkesh Podcast，80 分钟谈「智能体集群（agent swarms）与递归自我改进」**。他的核心判断有两条：一是**下一阶段的能力增量来自多个智能体并行、互相验证与分工，而不是继续把单个模型做大**——这延续了他从 Libratus、Pluribus 到 o1 一贯的「用推理时算力换训练时算力」路线；二是递归自我改进已经从哲学问题变成工程日程表，瓶颈在评估而不在训练。放到图谱里看，这与 Jeff Dean 的 Discovery Loop、Inherent 的 Faraday 是同一条线的三个入口：**「AI 做科研」的竞争正在从模型规模转向实验闭环的组织方式**。Brown 是 OpenAI 系里少数把方法论讲得最完整的人，这期值得对照 8 月 Sutton 谈持续学习那期一起读。", "persons": [{"id": "noambrown", "name": "Noam Brown"}], "sources": [{"label": "双语全文(AI Podcast)", "url": "https://aipodcast.jasonlin.tech/#/episode/noambrown-dwarkesh-2026"}]},
  {"id": "big-tech-glasses-fall-2026-09", "date": "2026-09-16", "type": "trend", "graphs": ["hardware", "investor"], "pinned": true, "title": "巨头 2026 秋集体下场眼镜：Snap 定价 2,195 美元、Google 秋季上市、Meta 卖断货——创业公司的窗口在关一半", "body": "**9 月 16 日，Snap 公布消费版 Specs 的细节：售价 2,195 美元，200 美元可退定金预订，美英法秋季发货，Verizon 为运营商合作方。** 同一个秋天里，Google 在 I/O 2026 上发布了与 Gentle Monster、Warby Parker 联名的 Android XR 眼镜，无显示音频款「今秋先上」；Meta 的 Ray-Ban Display（799 美元，含 Neural Band 肌电腕带）自去年秋上市后**在美国几乎所有门店售罄、等待名单排到 2026 年中**，但 CES 上宣布英法意加的海外上市**无限期推迟**、优先保美国供货。三家动作合起来读：**供给端不是没需求，是产能与光学良率跟不上；需求端被 Meta 一家占走 82–87% 的份额**（2025 年 700 万副）。对图谱里的眼镜创业公司，这意味着两件事——Even Realities 七月那笔 1.5 亿美元是踩着窗口关闭前融的；Rokid 与 XREAL 的港股 IPO 要在巨头新品铺货的同一个季度里定价。Snap 把价格定在 2,195 美元反而是好消息：它把自己划出了消费市场，留给了开发者。", "persons": [{"id": "evanspiegel", "name": "Evan Spiegel"}, {"id": "zuckerberg", "name": "Mark Zuckerberg"}, {"id": "bosworth", "name": "Andrew Bosworth"}, {"id": "osterloh", "name": "Rick Osterloh"}, {"id": "wangxiaoyi", "name": "Wang Xiaoyi"}], "sources": [{"label": "Bloomberg 9/16", "url": "https://www.bloomberg.com/news/features/2026-09-16/snap-shares-more-details-about-2-195-specs-ar-glasses-plus-verizon-partnership"}, {"label": "Google 官方(今秋上市)", "url": "https://blog.google/products-and-platforms/platforms/android/android-xr-io-2026/"}, {"label": "UploadVR(Display 售罄)", "url": "https://www.uploadvr.com/meta-ray-ban-display-sold-out-early-adopters-struggle/"}, {"label": "Android Central(海外推迟)", "url": "https://www.androidcentral.com/apps-software/meta/meta-ray-ban-display-updates-ces-2026"}]},
  {"id": "three-ceos-ai-risk-week-2026-09", "date": "2026-09-15", "type": "non-consensus", "graphs": ["ai-scholar", "hardware"], "pinned": false, "title": "一周之内三位 CEO 对 AI 风险的三种表态：Dario 说是警告信号、黄仁勋说是骗局、马斯克在中间", "body": "**9 月 13 日，Dario Amodei 上 CBS Sunday Morning 的 24 分钟专访**，把「AI 可能杀死所有人」的警告定性为「警告信号，而不是五级火警」，并提出让第三方安全评估机构介入的三步方案；同一周他在 Face the Nation 上说美中 AI 竞赛是「最难的两难」。**9 月 14 日，黄仁勋在 All-In 峰会**上把末日论直接叫作「骗局（hoax）」，认为超级智能在实践中已经到来、谁赢得 AI 谁赢得未来——对谈中途特朗普打进电话。**9 月 15 日，马斯克和 Gwynne Shotwell 同一舞台**，被问到 Dario 的警告时没有站队，转而讲 SpaceX 与 Tesla 该不该合并、Terafab 自建芯片厂、以及「同行评审」在 AI 安全里该扮演什么角色。三个人的分歧不是技术判断的分歧——三家都在全速训练——而是**对监管介入的态度**：Anthropic 主动要第三方评估，NVIDIA 认为监管叙事本身是对手的武器，xAI 把问题转移到硬件自主。图谱里这三个节点今年的每一次公开表态，都在为同一件事定价：谁来决定前沿模型能不能发布。", "persons": [{"id": "damodei", "name": "Dario Amodei"}, {"id": "jensen", "name": "Jensen Huang"}, {"id": "elon", "name": "Elon Musk"}], "sources": [{"label": "Dario × CBS 双语全文", "url": "https://aipodcast.jasonlin.tech/#/episode/dario-cbssunda-2026"}, {"label": "黄仁勋 × All-In 双语全文", "url": "https://aipodcast.jasonlin.tech/#/episode/jensen-allinpod-2026b"}, {"label": "马斯克 × All-In 双语全文", "url": "https://aipodcast.jasonlin.tech/#/episode/elon-allinpod-2026"}]},
  {"id": "ai-toys-return-rate-2026-09", "date": "2026-09-14", "type": "non-consensus", "graphs": ["hardware", "investor"], "pinned": false, "title": "AI 玩具一年融了 200 亿、卖得最快、退得也最快：7 天退货率 30–40%，大厂反而带不动", "body": "**2025 年至今，AI 玩具赛道累计融资事件超 50 起、金额超 200 亿元**（21 世纪经济报道口径）；跃然创新的 BubblePal 11 个月卖出 25–30 万台、营收破亿，全球第一，2026 年连融 A++ 与 B++；MOMOTOY 成立 4 个月估值 2.5 亿，FoloToy 一季度 2 万台、全年目标 30 万台。但同一篇报道给出的另一组数字是：**「AI 陪伴」品类 7 天退货率普遍 30% 以上，部分产品达 40%**——和 AI 眼镜一个量级。更反直觉的是大厂的表现：字节的「显眼包」靠稀缺在二手市场炒到 200% 溢价，华为联名款首发 15 分钟卖 6,500 台后没了下文——**流量能造一次爆款，造不出复购**。这个品类的真实结构是「潮玩逻辑 + 一颗大模型」：399 元主机加 59 元盲盒、IP 联名、Z 世代为情绪付费；决定生死的不是模型，是 IP 供给和退货率。对投资人图谱来说，这是 2026 年硬件里融资密度最高、也最像消费品而非科技的赛道。", "persons": [{"id": "liyong", "name": "Li Yong"}, {"id": "yangjianbo", "name": "Yang Jianbo"}, {"id": "hejiabin", "name": "He Jiabin"}], "sources": [{"label": "21 经济(大厂带不动)", "url": "https://www.21jingji.com/article/20260601/herald/3071c116ece697730a82f0a042d9fae8.html"}, {"label": "搜狐(2026 Q1 融资汇总)", "url": "https://www.sohu.com/a/1014037051_120177849"}]},
  {"id": "xreal-prospectus-flat-units-2026-09", "date": "2026-09-12", "type": "non-consensus", "graphs": ["hardware", "investor"], "pinned": false, "title": "XREAL 招股书是 AI 眼镜最诚实的一份材料：全球第一的份额、三年销量不涨、三年亏 20 亿、账上 6,363 万", "body": "**XREAL 4 月 1 日递表港交所后，招股书里的数字比任何行业报告都直白：AR 眼镜年销量 2023 年 13.72 万台、2024 年 12.49 万台、2025 年 13.37 万台——连续三年在 13 万台原地踏步**；营收 3.90 亿 → 3.95 亿 → 5.16 亿元，靠涨价而非放量；净亏损 8.82 亿 → 7.09 亿 → 4.56 亿，**三年累亏 20.5 亿元**；2025 年末现金仅 **6,363 万元**。毛利率从 18.8% 爬到 35.2% 是唯一的好消息，但招股书自己算的盈亏平衡点是**年销 40 万台——现在的三倍——约 2028 年**。它 12 轮融了约 23 亿元，红杉、高瓴、阿里、快手都在股东名单上，2025 年全球 AR 眼镜份额 27% 排第一。同一个月，Rokid 也在筹备港股（2025 年订单超 30 万台、2026 年目标 100 万台，但**从未披露利润**）。放在中国 2026 上半年智能眼镜卖了 90.9 万台、同比 +85.5% 的大盘上看，反差就是结论：**量是真的，退货率 30–70% 也是真的，第一名三年没涨销量，没有一家创业公司证明过单位经济模型**。两家 IPO 会给这个品类第一次二级市场定价。", "persons": [{"id": "xuchi", "name": "Xu Chi"}, {"id": "zhushanming", "name": "Zhu Shanming (Misa)"}, {"id": "lihongwei", "name": "Li Hongwei"}], "sources": [{"label": "BigGo 招股书要点", "url": "https://finance.biggo.com/news/ICgPip0BrdTHlKtCu4lo"}, {"label": "网易(Rokid 冲港股)", "url": "https://www.163.com/dy/article/KTI5P4OS0556M61W.html"}, {"label": "凤凰(上半年 90.9 万台)", "url": "https://tech.ifeng.com/c/8vZj0SOdaew"}, {"label": "新浪(退货重灾区)", "url": "https://finance.sina.cn/stock/jdts/2026-03-13/detail-inhqvtih4100189.d.html"}]},
  {"id": "smart-ring-patent-moat-2026-09", "date": "2026-09-11", "type": "trend", "graphs": ["hardware", "investor"], "pinned": false, "title": "智能戒指：穿戴里唯一同时有两家十亿美元收入的品类，但护城河是专利而不是 AI", "body": "Sacra 估算 **Oura 2025 年营收 10 亿美元、累计卖出 550 万枚、200 万付费订阅，2026 年上半年再收 7.64 亿美元**；WHOOP 2025 年年化预订 11 亿美元（+103%）、250 万会员、现金流转正，正在为 IPO 做准备。这是 AI 穿戴里唯一跑出两家十亿美元级收入的细分——但两家都是 2015 年前后创业、熬了十年的老公司，不是这两年的新钱。更值得记的是市场怎么被守住的：**Oura 2024 年向 ITC 起诉 Ultrahuman、RingConn、Circular，2025 年 8 月 ITC 裁定禁止 Ultrahuman 在美销售**；Ultrahuman 把戒指重新设计成一体钛管避开专利，2026 年 3 月才获海关放行；RingConn 选择和解、按年交专利费；三星的 Galaxy Ring 销量不佳，二代推迟到 2027。对硬件创业者的启示很朴素：**戒指的 AI 功能各家差不多，决定谁能留在货架上的是 2015 年申请的一批外壳结构专利**。", "persons": [{"id": "petteri", "name": "Petteri Lahtela"}, {"id": "willahmed", "name": "Will Ahmed"}, {"id": "mohitkumar", "name": "Mohit Kumar"}, {"id": "amaurykosman", "name": "Amaury Kosman"}], "sources": [{"label": "Sacra(Oura)", "url": "https://sacra.com/c/oura/"}, {"label": "Sacra(Whoop)", "url": "https://sacra.com/c/whoop/"}, {"label": "The Gadgeteer 3/2(Ultrahuman 回美)", "url": "https://the-gadgeteer.com/2026/03/02/america-banned-this-smart-ring-it-just-came-back/"}, {"label": "Android Police(Galaxy Ring 2)", "url": "https://www.androidpolice.com/things-are-looking-bleak-for-the-samsung-galaxy-ring-2/"}]},
  {"id": "home-robots-zero-deliveries-2026-09", "date": "2026-09-10", "type": "non-consensus", "graphs": ["hardware", "investor"], "pinned": false, "title": "家用机器人：估值加起来超过 120 亿美元的品类，到 9 月还没有一台到普通用户手里", "body": "把三家最受关注的家用机器人公司放在同一张表上看：**1X 的 NEO** 2025 年 10 月开预订，2 万美元或每月 499 美元，传洽 100 亿美元估值新轮——但截至 7 月中，**公开渠道找不到任何一例经核实的用户交付**，公司 4 月的工厂更新仍用将来时描述首批发货，且承认自主能力不足的任务靠远程操作补；**Sunday 的 Memo** 拿了 1.65 亿美元 B 轮（估值 11.5 亿美元），2026 年只给 **50 个「创始家庭」** 做 beta；**Weave 的 Isaac 1** 7 月发布，7,999 美元，秋季交付，是三家里唯一给出明确交付日期的——它的底气是 Isaac 0 在用户家里累计 2,000 多小时、每周叠 1,000 磅衣物的实测。这与人形赛道形成了反差：Counterpoint 数据上半年人形出货 2.2 万台，但六成是表演和采数据；家用赛道连表演的量都没有。**钱最多的品类交付最少**，不是因为没人认真做，而是家庭环境的长尾比工厂产线难一个量级——三家里最务实的路线恰恰是轮式底盘加叠衣服这种单任务，而不是双足通用。对投资人图谱而言，这一批的下一轮估值将第一次要用交付数而不是 demo 视频来支撑。", "persons": [{"id": "berntbornich", "name": "Bernt Børnich"}, {"id": "tonyzhao", "name": "Tony Zhao"}, {"id": "evanwineland", "name": "Evan Wineland"}], "sources": [{"label": "1X NEO 评测(交付核实)", "url": "https://antonrobots.com/1x-neo-review/"}, {"label": "MLQ(Sunday 1.65 亿美元)", "url": "https://mlq.ai/news/sunday-robotics-raises-165-million-series-b-at-115-billion-valuation-for-home-robot-launch/"}, {"label": "The Robot Report(Weave Isaac 1)", "url": "https://www.therobotreport.com/weave-robotics-launches-isaac-first-mobile-humanoid-robot/"}]},
  {"id": "ai-design-leads-personas-2026-09", "date": "2026-09-10", "type": "trend", "graphs": ["designer"], "pinned": false, "title": "OpenAI、Anthropic、ElevenLabs 的设计负责人同一周开讲：围绕人物画像而不是功能来组织设计团队", "body": "九月第二周，三家 AI 公司的设计负责人接连出现在播客里：**Ed Bayes（OpenAI 设计负责人，负责 Codex 与 ChatGPT Work 的原型）** 9 月 9 日上 Dive Club，讲「为六个月后的未来而设计」——界面是动态生成的，信息架构比像素重要，设计团队按**用户画像（persona）而不是按功能模块**来分工；**Joel Lewenstein（Anthropic）** 9 月 10 日在 South Park Commons 谈在 Anthropic 做设计，主题是当模型能力每三个月换一次时，设计师的工作从「定义交互」变成「定义边界」；**Nev Flynn（ElevenLabs 设计负责人）** 谈面向语音智能体的「智能体原生」设计系统。三个人说的是同一件事的三个侧面：**当产品的核心交互由模型生成，设计的对象从界面转向了人——你为谁设计，比你设计了什么更稳定**。这也是为什么 2026 年 AI 公司的设计负责人集体在讲组织方式而不是在讲作品。三位本周已加入图谱。", "persons": [{"id": "edbayes", "name": "Ed Bayes"}, {"id": "joellewenstein", "name": "Joel Lewenstein"}, {"id": "nevflynn", "name": "Nev Flynn"}], "sources": [{"label": "Ed Bayes × Dive Club 双语全文", "url": "https://aipodcast.jasonlin.tech/#/episode/edbayes-diveclub-2026"}, {"label": "Joel Lewenstein × SPC 双语全文", "url": "https://aipodcast.jasonlin.tech/#/episode/joellewenstein-southpar-2026"}, {"label": "Nev Flynn × Dive Club 双语全文", "url": "https://aipodcast.jasonlin.tech/#/episode/nevflynn-diveclub-2026"}]},
  {"id": "ai-pendant-wave-settled-2026-09", "date": "2026-09-09", "type": "non-consensus", "graphs": ["hardware", "investor"], "pinned": false, "title": "AI 挂件这一波结算完了：死的死、收的收、欠薪的欠薪，唯一跑通的是没拿 VC 的 PLAUD", "body": "到 2026 年 9 月，2024 年那一波「AI 随身设备」的命运已经全部揭晓。**Humane** 融 2.3 亿美元、卖出约 1 万台，2025 年 2 月停售，HP 花 1.16 亿美元收了专利；**Rabbit R1** 卖了 10 万台后大规模退货，员工自 2025 年 7 月起领不到工资、10 月起罢工，公司仍在推固件并预告下一代；**Limitless** 12 月被 Meta 收购、停售新客；**Bee** 7 月被 Amazon 收购，CES 2026 作为 Alexa 路线图的一部分展出；**Friend** 跳票两年后 7 月出 2.0，价格翻倍到 249 美元，评测说它记不住三天前的事。反面是 **PLAUD**：零 VC 做到 2.5 亿美元 ARR、累计 200 万台，软件订阅 6 月突破 1 亿美元 ARR，之后才按 20 亿美元估值引入机构，2026 年目标 5 亿美元销售额。区别不在硬件，在卖什么——**跑通的卖的是「录音+转写」这个明确功能，死掉的卖的是「AI 伴侣」这个叙事**。Meta 和 Amazon 各买走一家之后，这个品类对新创业者已经关门：Meta 计划 2026 年推出自己的录音挂件，目标 1,000 万台。", "persons": [{"id": "xugao", "name": "Xu Gao"}, {"id": "imranchaudhri", "name": "Imran Chaudhri"}, {"id": "jesselyu", "name": "Jesse Lyu"}, {"id": "dansiroker", "name": "Dan Siroker"}, {"id": "mariazollo", "name": "Maria de Lourdes Zollo"}, {"id": "avischiffmann", "name": "Avi Schiffmann"}], "sources": [{"label": "TechCrunch 6/16(PLAUD 软件 ARR)", "url": "https://techcrunch.com/2026/06/16/plaud-says-its-software-business-topped-100m-in-arr-after-shipping-over-2m-ai-notetakers/"}, {"label": "TechSpot(Rabbit 欠薪)", "url": "https://www.techspot.com/news/110256-rabbit-employees-they-havent-paid-months-but-r1.html"}, {"label": "TechCrunch 7/30(Friend 2.0)", "url": "https://techcrunch.com/2026/07/30/friend-the-lonely-ai-wearable-returns-with-a-new-voice-and-a-much-bigger-price-tag/"}, {"label": "SolidAITech(死亡名单)", "url": "https://www.solidaitech.com/2026/08/ai-wearable-dead-brands-best-picks.html"}]},
  {"id": "mistral-3b-samsung-2026-09", "date": "2026-09-08", "type": "funding", "graphs": ["ai-scholar", "investor"], "pinned": false, "title": "Mistral 融 30 亿欧元、估值 210 亿：三星领投，欧洲唯一的前沿实验室一年估值翻倍", "body": "**9 月 8 日，Mistral AI 宣布完成 30 亿欧元（约 35 亿美元）融资，三星领投**，欧盟支持的 Scaleup Europe 基金（EQT 管理）与老股东 PSG Equity 参投，**投后估值超 210 亿欧元（约 240 亿美元）**——一年前 ASML 领投那轮是 117 亿欧元，估值接近翻倍。Arthur Mensch 说钱会花在自建数据中心和对外出租算力上，并预计 2026 年 ARR 超过 10 亿美元。两个值得记的信号：一是**领投方连续两轮都是硬件巨头而不是风投**——先 ASML、再三星，欧洲 AI 的资本结构正在由产业资本兜底；二是 Mistral 开始把自己当算力商而不只是模型商，这与本月 Figure 承诺 35 亿美元算力是同一条线——**前沿实验室和头部硬件公司都在把融资额的大头换成 GPU**。对图谱里的 Transformer 作者群与 DeepMind 系而言，Mistral 是欧洲唯一一个仍在独立训练前沿模型的样本。", "persons": [{"id": "mensch", "name": "Arthur Mensch"}, {"id": "lample", "name": "Guillaume Lample"}, {"id": "lacroix", "name": "Timothee Lacroix"}], "sources": [{"label": "CNBC 9/8", "url": "https://www.cnbc.com/2026/09/08/mistral-ai-funding-valuation-samsung.html"}, {"label": "France 24 9/8", "url": "https://www.france24.com/en/europe/20260908-french-ai-startup-mistral-raises-3-billion-euros-after-latest-funding"}]},
  {"id": "mech-mind-hk-ipo-2026-09", "date": "2026-09-01", "type": "funding", "graphs": ["hardware", "investor"], "pinned": false, "title": "梅卡曼德港股上市：人形淘金热里先上岸的是「眼脑手」卖铲人", "body": "**9 月 1 日，梅卡曼德（Mech-Mind）在港交所主板上市，发行价 101.7 港元，含超额配售募资约 27 亿港元**，被称为「具身眼脑手第一股」。它不做本体，卖的是机器人的标准化零部件：Mech-Eye 工业 3D 相机（感知）、Mech-GPT 多模态具身模型（决策）、Mech-Hand 灵巧手（执行）——弗若斯特沙利文口径，2025 年全球 AI + 3D 视觉引导通用机器人部件市场它按收入占约 22%、按出货超 27%，超过后四名之和。三位清华同学 2016 年创办，十年后敲锣。放在图谱里看，这是继 6 月光轮智能之后第二个印证「卖铲人先赚钱」的样本：本体公司还在比出货量与融资额，部件商已经拿到二级市场定价。值得盯的是它招股书里的用途结构——约三成投研发、三成投全球化，扩产能只占 5%，说明它把自己定位成软件定义的部件平台，而不是制造商。", "persons": [{"id": "mechmind", "name": "Shao Tianlan"}], "sources": [{"label": "腾讯新闻 9/1", "url": "https://view.inews.qq.com/a/20260901A070Q800"}, {"label": "21 财经 9/2", "url": "https://m.21jingji.com/article/20260902/herald/38b8f706f2728f782a3a7718071125bb.html"}, {"label": "动点科技 8/27(卖铲人)", "url": "https://cn.technode.com/post/2026-08-27/mech-mind-ipo/"}]},
  {"id": "figure-nscale-3-5b-compute-2026-09", "date": "2026-09-03", "type": "non-consensus", "graphs": ["hardware", "investor"], "pinned": false, "title": "Figure 只融过 19 亿美元，却签下 35 亿美元算力：人形机器人公司开始像大模型实验室一样烧 GPU", "body": "**9 月 3 日，Figure 宣布与 AI 算力商 Nscale 签署战略合作：初始承诺 35 亿美元算力，意向扩大到 60 亿美元以上，部署最多 10 万张 NVIDIA Vera Rubin GPU**，2027 年下半年起在得州 Barstow 上线；Nscale 同时对 Figure 进行战略投资，双方还将探讨用人形机器人扩建 Nscale 的供应链。反差在于体量：Figure 历史累计融资约 19 亿美元（最近一轮是 2025 年 9 月、390 亿美元估值的 C 轮），**算力承诺是它全部融资额的近两倍**——这只能靠分期付款、以算力换股权或下一轮更大的融资来兑现。它传递的信号是：头部人形机器人公司已经把自己定义成「物理世界的基础模型实验室」，竞争的瓶颈从本体和产线转向训练算力，而算力商反过来成了投资人。对图谱里 2026 年密集融资的中国人形公司，这是一个新的参照系——出货量之外，谁有 10 万卡量级的训练预算。", "persons": [{"id": "brettadcock", "name": "Brett Adcock"}], "sources": [{"label": "Figure 官方公告 9/3", "url": "https://www.figure.ai/news/figure-and-nscale-sign-strategic-partnership"}, {"label": "Forbes 9/4(19 亿 vs 35 亿)", "url": "https://www.forbes.com/sites/johnkoetsier/2026/09/04/how-figure-committed-35-billion-for-ai-compute-after-raising-only-19-billion/"}]},
  {"id": "vast-tripo-3b-series-b-2026-09", "date": "2026-09-01", "type": "funding", "graphs": ["ai-scholar", "investor"], "pinned": false, "title": "VAST 六个月吸金约 57 亿元：AI 3D 生成成了「半个游戏圈」的共同下注", "body": "**9 月 1 日，AI 3D 大模型公司 VAST（Tripo 母公司）宣布完成 B 轮与 B+ 轮融资，合计约 30 亿元，经纬创投领投**，完美世界、三七互娱、延趣游戏等游戏厂商集体入股，中金、CMC、达晨等老股东跟投。加上 7 月刚完成的超 10 亿元 A3 战略轮，**VAST 在不到六个月里累计融资约 57 亿元**，刷新 3D 原生智能领域纪录。创始人**宋亚宸生于 1997 年**，约翰霍普金斯本科，2019 年入商汤做 AIGC 3D，之后以 **MiniMax 001 号员工**身份参与创办 MiniMax，2022 年 11 月创立 VAST。数字侧：2025 年 7 月 ARR 达 1200 万美元；Tripo 教育计划覆盖 30 多国 350 余所高校。这轮的信号不在金额，而在**谁在出钱**——游戏公司不是财务投资人，是把自己的内容管线押在了「文本到可交互 3D 资产」上；同步发布的 Tripo P2.0 已能输出兼容 NVIDIA Isaac Sim 的物理仿真场景，3D 生成正在同时给游戏和具身智能供数据。", "persons": [{"id": "songyawei", "name": "Song Yawei"}, {"id": "zhangying", "name": "Zhang Ying"}], "sources": [{"label": "投资界 9/1", "url": "https://news.pedaily.cn/202609/568395.shtml"}, {"label": "钛媒体 9/3(创始人背景)", "url": "https://www.tmtpost.com/8127562.html"}]},
  {"id": "xpeng-robotics-900m-round-2026-08", "date": "2026-08-25", "type": "funding", "graphs": ["hardware", "investor"], "pinned": false, "title": "小鹏机器人首轮融资超 9 亿美元、投后估值超 63 亿美元：中国具身智能单轮纪录被车企改写", "body": "**8 月 25 日，小鹏集团宣布旗下人形机器人业务完成首轮股权融资，规模超 9 亿美元，投后估值超 63 亿美元**，创下中国具身智能行业单轮私募股权融资纪录，超过此前任何一家本体公司的单轮金额。**IDG 资本领投、高榕创投参投，腾讯与阿里巴巴以战略投资者身份入局**；交割后小鹏集团仍控股，资金用于 IRON 人形机器人量产与小鹏物理 AI 模型迭代。值得注意的三点：一是**资本第一次给「车企造人」单独定价**——具身业务被从整车估值里剥离出来独立融资；二是 IDG 在同一个月同时押注了本体与上游，投资人图谱里 IDG 合伙人的具身版图再次扩大；三是这笔钱到账正好在宇树上市首日暴涨 460% 的一周后，一级市场用最快的速度把二级市场刚给出的定价锚兑现成了新估值。", "persons": [{"id": "xiaopenghe", "name": "He Xiaopeng"}, {"id": "xiongxg", "name": "Xiong Xiaoge"}, {"id": "gaorong", "name": "Gao Rong team"}], "sources": [{"label": "新浪财经 8/25", "url": "https://finance.sina.com.cn/jjxw/2026-08-25/doc-inipprnq5510289.shtml"}, {"label": "凤凰网(车企造人)", "url": "https://finance.ifeng.com/c/8vrMu2ZxSPC"}]},
  {"id": "inherent-faraday-27b-2026-08", "date": "2026-08-22", "type": "research", "graphs": ["ai-scholar"], "pinned": false, "title": "Inherent：12 人团队用 27B 小模型「独立复现论文」胜过 Opus 4.8 与 GPT-5.5", "body": "**8 月 22 日，伦敦 AI 实验室 Inherent 发布 AI 智能体 Faraday**：在不预先知道答案的前提下独立复现已发表论文的结论，得分超过 Anthropic 的 Claude Opus 4.8 与 OpenAI 的 GPT-5.5——而底座只是 **270 亿参数的 Qwen 3.6**。公司由 DeepMind 出身的 **Edward Hughes**（首席科学家，曾共同领导 DeepMind 的 AI Scientist 团队、写下 Genie 1 的最终实现、参与 AlphaProof）、Louis Kirsch、Kaloyan Aleksiev 与 Tantum Collins 创办，5 月带着 **5000 万美元种子轮**走出隐身，目前约 12 人，年底计划扩到 20–25 人。它挑战的是一个越来越主流的假设——「科研智能体的能力来自更大的前沿模型」；Inherent 的答案是用开放式（open-ended）训练环境让小模型学会「做实验」本身。与 Jeff Dean 的 Discovery Loop、Periodic Labs 一道，「AI 科学家」正从大厂研究项目变成独立创业赛道。", "persons": [{"id": "edwardhughes", "name": "Edward Hughes"}, {"id": "jackph", "name": "Jack Parker-Holder"}], "sources": [{"label": "TechCrunch 8/22", "url": "https://techcrunch.com/2026/08/22/inherent-founded-by-deepmind-alumni-says-its-ai-teammate-just-outperformed-anthropic-and-openai-at-replicating-research/"}, {"label": "Edward Hughes 主页", "url": "https://edwardhughes.io/"}]},
  {"id": "quantumlight-fund-ii-500m-2026-08", "date": "2026-08-19", "type": "non-consensus", "graphs": ["investor"], "pinned": false, "title": "QuantumLight 5 亿美元二期超募：算法选项目的 VC 用 15 个月把基金翻倍", "body": "**8 月 19 日，Revolut 创始人 Nik Storonsky 的风投机构 QuantumLight 宣布二期基金关账，规模 4.32 亿欧元（约 5 亿美元），超募**；距离 2025 年 5 月 2.22 亿欧元的一期仅 15 个月，规模翻倍。它的非共识在于方法：项目筛选由自研 AI 系统 **Aleph** 完成，评估成长期公司时**几乎不需要人工介入**，合伙人的角色更接近「审核算法输出」。成绩单：**27 家被投公司中 5 家已是独角兽**（Together AI、Function Health、Factory、Robin AI、Ben）。七十年来风险投资的护城河一直是关系网络与判断力，QuantumLight 押的是「数据密度已经足够让筛选被自动化」。真正的检验还没来——LP 用翻倍的钱投了赞成票，但算法型 VC 的组合从未经历过一次完整的估值回撤周期。", "persons": [], "sources": [{"label": "Fund Momentum 8/19", "url": "https://fundmomentum.vc/blog/quantumlight-fund-ii-500m-nik-storonsky-ai-driven-vc-2026"}, {"label": "Tech Funding News", "url": "https://techfundingnews.com/storonsky-quantumlight-closes-500m-fund-ii-ai-startups/"}]},
  {"id": "humanoid-shipments-1h26-counterpoint", "date": "2026-08-19", "type": "trend", "graphs": ["hardware"], "pinned": false, "title": "上半年人形机器人出货 2.2 万台、同比近 300%：智元反超宇树登顶，但六成买家是「表演与采数据」", "body": "**Counterpoint 8 月 19 日数据：2026 上半年全球人形机器人出货超 2.2 万台，同比增长近 300%**。排名第一的是**智元（9,700 台，份额约 43%）**，宇树以 7,000 余台、31% 退居第二，两家合计约 75%，前五家占 86%——这是智元首次在出货量上反超宇树，时点恰在双方 IPO 前后。更该被看见的是用途结构：**娱乐表演与数据生产/科研合计占六成以上**，智能制造仅 13%，仓储物流 5%。换句话说，2026 年的人形机器人主要还是在「表演」和「给别的机器人当训练数据」，真正进产线的不到两成。Counterpoint 预测全年出货将超 5 万台（+210%）；对图谱里的本体公司而言，出货量榜单的座次正在替代融资额，成为新的叙事货币。", "persons": [{"id": "pengzhihui", "name": "Peng Zhihui"}, {"id": "wangxingxing", "name": "Wang Xingxing"}], "sources": [{"label": "Counterpoint 8/19", "url": "https://counterpointresearch.com/en/insights/global-humanoid-robot-shipments-soar-nearly-300-percent-yoy-in-h1-2026"}, {"label": "SCMP(智元反超宇树)", "url": "https://www.scmp.com/tech/tech-trends/article/3363544/agibot-overtakes-unitree-top-global-humanoid-robot-vendor-first-half-amid-ipo-push"}]},
  {"id": "jeff-dean-discovery-loop-2026-08", "date": "2026-08-05", "type": "relationship", "graphs": ["ai-scholar", "investor"], "pinned": false, "title": "Jeff Dean 离开谷歌 27 年创办 Discovery Loop：带走 Ghemawat、Quoc Le、Vinyals，Alphabet 出钱又出一年算力", "body": "**8 月 5 日，谷歌首席科学家 Jeff Dean 宣布离开供职 27 年的谷歌（1999 年入职，第 30 号员工），出任新公司 Discovery Loop 的 CEO**。这是一家公益企业（PBC），目标是用 AI 自动化「提出假设—跑实验—学习结果」的科研闭环，同时并行发起数千个实验。联合创始人阵容几乎是谷歌系统与 AI 两条血脉的合流：**Sanjay Ghemawat**（Google Senior Fellow，与 Dean 合著 MapReduce/Bigtable/Spanner）、**Quoc Le**（Google Brain 创始成员）、**Oriol Vinyals**（DeepMind 研究副总裁、Gemini 联合负责人）。首轮由 **Radical Ventures 与 Khosla Ventures 联合领投**，Kleiner Perkins、Lightspeed、Doerr Capital 跟投；**Alphabet 既出资又承诺至少第一年的算力供应**——这更像谷歌为留住关系而设计的「体外孵化」，而不是一次单纯的人才流失。今年 DeepMind 已先后失去 David Silver、John Jumper 与三名核心研究员，这一次走的是「最像谷歌的那个人」。", "persons": [{"id": "dean", "name": "Jeff Dean"}, {"id": "ghemawat", "name": "Sanjay Ghemawat"}, {"id": "quocle", "name": "Quoc V. Le"}, {"id": "vinyals", "name": "Oriol Vinyals"}, {"id": "jordanjacobs", "name": "Jordan Jacobs"}, {"id": "vinodkhosla", "name": "Vinod Khosla"}], "sources": [{"label": "TechCrunch 8/5", "url": "https://techcrunch.com/2026/08/05/jeff-dean-and-other-top-ai-researchers-are-leaving-google-to-launch-their-own-startup/"}, {"label": "Bloomberg 8/6", "url": "https://www.bloomberg.com/news/articles/2026-08-06/google-grapples-with-exit-of-ai-pioneer-and-most-google-person"}]},
  {"id": "figma-q2-2026-earnings", "date": "2026-08-05", "type": "non-consensus", "graphs": ["designer"], "pinned": false, "title": "四月被 Claude Design「杀死」的 Figma，Q2 营收增 48%、连续三个季度加速", "body": "**8 月 5 日，Figma 发布 2026 年二季度财报：营收 3.701 亿美元，同比增长 48%，连续第三个季度加速**；净收入留存率（NDR）136%，全年营收指引上调 4000 万美元至 14.63–14.67 亿美元（中值增长 39%）。这是 **AI credit 加购项完整变现的第一个季度**——客户在扩座位的同时开始为 AI 额度付费。对照四个月前的叙事：4 月 17 日 Anthropic 发布 Claude Design 当天，Figma 股价跌 6%，Adobe、Wix 同步下挫，「设计工具被前沿模型吞掉」一度成为共识。Dylan Field 在财报电话会上的回应是：**代码被商品化，价值向上移动，Figma 的机会反而变大了**。数据暂时站在他这边——至少在 2026 年，「AI 会杀死设计工具」和「设计工具因 AI 加速增长」同时成立，区别只在于谁把 AI 变成了可计费的额度。", "persons": [{"id": "dylanfield", "name": "Dylan Field"}], "sources": [{"label": "Figma IR 8/5", "url": "https://investor.figma.com/news-events/news/news-details/2026/Figma-Announces-Second-Quarter-2026-Financial-Results/default.aspx"}, {"label": "The New Stack(Claude Design 发布)", "url": "https://thenewstack.io/anthropic-claude-design-launch/"}]},
  {
...
const FOOTER_LINKS = [
  ...
  { id: "ai-scholar", label: "AI 学者图谱",   url: "https://ai.jasonlin.tech/" },
