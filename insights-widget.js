...
const INSIGHTS_DATA = [
  {
    "id": "byd-humanoid-self-build-oem-2026-06-06",
    "date": "2026-06-06",
    "type": "non-consensus",
    "graphs": [
      "hardware"
    ...
    "pinned": false,
    "title": "比亚迪自研人形机器人：车企从「买方」变「造方」的结构拐点",
    "body": "6 月 3 日，**比亚迪**执行副总裁**李柯**首次公开确认正「全力推进」人形机器人自主研发，初期场景是全球 **4S 门店**——「每个门店配置 4 台机器人」充当多语言导购，解决海外招工难；技术成熟后由门店面向消费者开售。6 月 6 日官方辟谣「代号尧舜禹、第七代原型机、年内自用 2 万台」等泄露细节，但自研方向与门店战略未否认。**非共识**：比亚迪（2025 年全球 EV 出货约 **176 万辆**）入局的方式不是「买机器人做客户」而是「自己造、自己用」——与特斯拉 Optimus、小鹏 IRON（2026 年底量产）同一逻辑，将汽车厂从具身赛道「最期待的 B 端大客户」变成「自研竞争者」。**对创业者的实操含义**：纯做人形本体须重算 TAM，车厂自研路线落地后剩余客户将压缩至中小制造业；比亚迪已明确「开放平台」战略，核心零部件（灵巧手/感知/末端执行器）的 Tier-1 供应商比本体整合商更抗压；评估车企机器人项目，先问「有没有内部先消化的订单」，有则验证速度是纯初创的 10 倍",
    "persons": [],
    "sources": [
      { "label": "新浪财经：比亚迪确认自研人形机器人，成熟后走向4S店开售（2026-06-04）", "url": "https://news.sina.com.cn/external/car/2026-06-04/doc-iniafmmw9469792.shtml" },
      { "label": "新浪财经：比亚迪辟谣，事关人形机器人（2026-06-06）", "url": "https://finance.sina.com.cn/jjxw/2026-06-06/doc-iniamxru7620173.shtml" }
    ]
  },
  {
