...
const INSIGHTS_DATA = [
  ...
  },
  {
    ...
    "body": "对 71 位投资人节点做出生年份归纳:已识别出生年份 16 人,**1950s 4 人 + 1960s 5 人 + 1970s 6 人 = 15 人占 94%**,1980 后只有 1 人(曹毅 1987,源码资本)。对比同期硬件创业者图谱:1980s 11 人 + 1990s 10 人占 84%。**这意味着 2026 年中国 VC 的投资决策者比被投人晚 1 个完整代际(15-25 岁)**——95 后已经在做硬件 / 具身 / AI 创业(王兴兴 1990、张俊彬 1990、陈建宇 1992、王鹤 1992),但同代的人几乎没人在管基金。**非共识判断**:这是 2026 中国 VC 圈最大的代际错位。美国 1990 年代也有过相同状态(Sand Hill Road 都是 50-60 岁老白男看 25 岁项目),但 2010 后 a16z(Marc Andreessen 1971)/Founders Fund(Peter Thiel 1967)/Y Combinator(Sam Altman 1985)等机构让 30-40 岁的人进入投决会,反而提升了硅谷生态质量——硅谷 90 后创业者能找到 80 后投资人对话。中国还差这个代际转换。**底层逻辑**:管理 LP 资金需要 10-15 年 track record,80 后投资人(1985 出生)2026 年才 41 岁,2014-2016 年才开始独立做 GP——刚好赶上一波资管收缩,大基金管理人还是 60-70 后。这个错位至少要再 5-8 年才能补齐。**实操含义**:(1)如果你是 90 后硬件 / AI 创业者,见 VC 时不要默认对方理解你的产品(代际理解差),要花前 10 分钟讲「这个产品在 2030 年值什么」用 LP 听得懂的语言(IPO 路径 + ARR + 估值锚定),而不是「用户喜欢什么」;(2)如果是 95-00 后,优先找 80 后投资人(比如曹毅 / 戴雨森 / 杨杰),即使 ticket size 小但拍板快;(3)对投资人:80-90 后这一代下海做基金的人是结构性稀缺,3-5 年后会非常值钱。",
    "persons": [
      {
        "id": "caoyi",
        "name": "曹毅(源码资本 1987)"
