...
const INSIGHTS_DATA = [
  ...
  // ===== Weekly 2026-06-01 =====
  {
    "id": "deep-robotics-ipo-quadruped-first-profitable-2026",
    "date": "2026-06-01",
    "type": "trend",
    "graphs": ["hardware"],
    "pinned": false,
    "title": "云深处科创板 IPO — 四足机器人年收 3.37 亿先于人形实现盈利，两家杭州机器人今日同台上会",
    "body": "2026 年 5 月 18 日，「杭州六小龙」之一的**云深处科技（Deep Robotics）**科创板 IPO 获受理，中信建投保荐，拟募资 **25.03 亿元**；创始人朱秋国（浙大副教授）持股 31%。财务画像：2023-2025 年营收 5000 万→1.03 亿→**3.37 亿元**（CAGR 160%），**2025 年首次扭亏为盈**，四足机器人年出货约 **4000 台**。弗若斯特沙利文：2025 年四足行业应用收入**全球第一**。今天（6 月 1 日），宇树（人形）与云深处（四足）同日面临科创板上市委审议——两家杭州机器人公司共享历史性聚光灯。**非共识判断**：外界把 2026 的机器人叙事锁定在「人形」，但真正率先跑通商业闭环、先于人形机器人实现净利的是**四足机器人**——电力巡检、矿山勘探、应急救援场景不需要拟人外形，只需要能走复杂地形、能替代人下危险现场的腿。四足的技术难度低于人形（两腿稳定性比四腿难一个量级），但部署场景对「可靠性」的要求极高，反而比展览型人形更快产生付费复购。**实操含义**：(1)机器人创业者别把腿的数量等于机会大小——四足/轮足才是 2026 年现金流里程碑更近的路径；(2)投资人看机器人，先分「电力/矿山/应急 B 端付费」和「科研/展演/本体开发者采购」两种结构，云深处的电力/矿山客户是真实重复采购——这才是估值地基；(3)两家杭州机器人同天上会，给城市机器人产业一个样本：真正的生产力不是「人形机器人园区」招牌，而是浙大/港科大这样能批量产出具备腿式机器人经验的导师体系。",
    "persons": [
      {"id": "zhuqiuguo", "name": "朱秋国（云深处）"},
      {"id": "wangxingxing", "name": "王兴兴（宇树）"}
    ],
    "sources": [
      {"label": "央视财经：云深处科创板 IPO 获受理，拟募资 25.03 亿元（2026-05-19）", "url": "https://finance.cctv.com/2026/05/19/ARTI6wqSGP1quU7Tgv6hv9yA260519.shtml"},
      {"label": "新浪财经：云深处科创板 IPO 获受理，四足机器人玩家的光鲜与隐忧（2026-05-19）", "url": "https://finance.sina.com.cn/wm/2026-05-19/doc-inhynmhx1956445.shtml"},
      {"label": "新浪财经：宇树科技科创板 IPO 将于 6 月 1 日上会（2026-05-26）", "url": "https://finance.sina.com.cn/wm/2026-05-26/doc-inhzfshn1379119.shtml"}
    ]
  },
  {
    "id": "consumer-robot-retail-moment-mofcom-2026",
    "date": "2026-06-01",
    "type": "trend",
    "graphs": ["hardware"],
    "pinned": false,
    "title": "商务部证实 AI 眼镜 +175%、宇树亚洲首店开业 — 机器人与智能穿戴正式进入消费渠道",
    "body": "两个信号共同标记了「B2B 展台→消费货架」的临界时刻。**信号一**：5 月 26 日商务部发布 4 月消费数据：**智能眼镜网络零售额同比 +175.2%，人形机器人 +20.6%**——官方首次在月度消费统计里单列「人形机器人」品类，意味着其供应链、质检标准已纳入常规统计口径。**信号二**：5 月 31 日，宇树科技在上海陆家嘴开设**亚洲首家具身智能体验馆**，消费者可现场购买 G1/B2 系列。同期 Vbot（维他动力）「大头」消费级机器人已完成首批 500 台量产交付、5 月超 1500 台，6 月目标产能 2500 台/月。**非共识判断**：多数人把「人形机器人进商场」读成营销事件，真正结构性的变化是——**当商务部月度数据单独统计一个品类，意味着它已形成稳定的供应链与消费频次**，这比任何发布会数字都难造假。体验馆是可见表面，背后是零售体系、售后服务和消费者权益保护的全套基础设施跟进。AI 眼镜 +175.2% 加上 IDC 预测 2026 年全球出货 2368 万台，意味着这个品类已过了「早期极客」阶段，进入「大众尝鲜」阶段。**实操含义**：(1)做消费级机器人，「被商务部月度数据收录」是商业化成立的行政确认，比出货量宣传更可信；(2)「进 SKP/陆家嘴开店」的真正价值不是销售额，而是让消费者第一次在没有销售员辅助的环境下体验产品，测出真实的转化率和留存意愿；(3)AI 眼镜的 +175.2% 对渠道选品有直接意义——这是 2026 年上半年增速最快的消费电子细分品类，3C 渠道商应现在就做选品规划，而不是等爆款出现再追。",
    "persons": [
      {"id": "wangxingxing", "name": "王兴兴（宇树）"},
    ...
    "sources": [
      {"label": "中新网：商务部 4 月消费数据 — 智能眼镜 +175.2%、人形机器人 +20.6%（2026-05-26）", "url": "https://www.chinanews.com.cn/cj/2026/05-26/10628535.shtml"},
      {"label": "证券时报：宇树科技具身智能体验馆亚洲首店将于 5 月 31 日在上海开业（2026-05-29）", "url": "https://www.stcn.com/article/detail/3934883.html"},
      {"label": "The AI Insider：Chinese Humanoid Startup Vbot Raises $73M Pre-A（2026-05-11）", "url": "https://theaiinsider.tech/2026/05/11/report-chinese-humanoid-robot-startup-vbot-raises-usd-73m-in-pre-a-funding/"}
    ]
  },
  {
    "id": "unitree-wvla2-japan-hardware-vla-2026",
    "date": "2026-06-01",
    "type": "trend",
    "graphs": ["hardware"],
    "pinned": false,
    "title": "宇树自研 WVLA2.0 + G1 进羽田机场 — 硬件公司做自己的 VLA 模型是必然，不是炫技",
    "body": "5 月 25 日，宇树科技发布 **WVLA2.0 具身大模型**，同步落地 G1 人形机器人「会议室自主整理」应用；同月，宇树 G1 正式进驻**东京羽田机场**，由日本航空（JAL）启动试点——承担行李装卸、货物转运、传送带协同等地勤作业。这是中国人形机器人第一次大规模进入日本核心基础设施场景。**非共识判断**：外界把宇树「自研 VLA」读成和 Physical Intelligence、智元同类型的 AI 研究故事，但宇树是从另一方向走进来的：**G1 本体已经在外部客户场景里运行，WVLA2.0 是为了让它在真实环境「干得更好」，不是为了学术发表**。对硬件公司来说，自研 VLA 的真正动力是**场景控制权**：买第三方 VLA 的机器人公司等于把最关键的适配权交出去，当客户要定制新任务，必须依赖模型提供商的迭代节奏；自研 VLA 的团队可以直接在客户现场快速迭代——这才是真正的「以模型锁定客户」护城河。羽田机场的选择也有战略意义：日本是中国机器人出海「技术公信力最高、制裁风险最低」的跳板，且日本制造业/服务业老龄化缺工问题比欧美更迫切。**实操含义**：(1)做人形机器人，VLA 是「让机器人在 B 端场景提效」的工具，评估 VLA 要用实际部署任务完成率、而非 benchmark 分数；(2)中国机器人出海路径首选「日本+德国制造/服务场景」，而不是直接冲美国（制裁风险）或新兴市场（购买力不足）；(3)对 AI infra 供应商：头部机器人公司自研意味着「卖 VLA API」的模式空间在收窄，基础模型厂要重新思考与机器人公司的分工边界——能卖的是「通用预训练权重」而非「完整部署方案」。",
    "persons": [
      {"id": "wangxingxing", "name": "王兴兴（宇树）"},
      {"id": "karolhausman", "name": "Karol Hausman（Physical Intelligence）"},
      {"id": "pengzhihui", "name": "彭志辉（智元）"}
    ],
    "sources": [
      {"label": "证券时报：宇树科技科创板 IPO 将于 6 月 1 日上会（含 WVLA2.0 与日本部署信息）（2026-05-26）", "url": "https://www.stcn.com/article/detail/3926344.html"},
      {"label": "新浪财经：宇树科技科创板 IPO 上会，G1 机器人进驻东京羽田机场（2026-05-26）", "url": "https://finance.sina.com.cn/wm/2026-05-26/doc-inhzfshn1379119.shtml"}
    ]
  }
];
